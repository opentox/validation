...
#        $sinatra.url_for('/bootstrapping',:full) )
    ...
    def self.train_test_dataset_split( orig_dataset_uri, prediction_feature, subjectid, stratified="false",
      split_ratio=nil, random_seed=nil, missing_values=nil, task=nil, features=nil, store_split_clusters=false )
      ...
      case stratified
      when /^(true|super|super4|super5|super_bin|contra_eucl2|contra_bin2)$/
        ...
        elsif stratified=="contra_eucl2" or stratified=="contra_bin2" 
      ...
      when "false"
        raise "store split clusters not available for random splits" if store_split_clusters
        ...
        raise OpenTox::BadRequestError.new "stratified != false|true|super|contra_eucl2|contra_bin2, is #{stratified}"
      end
      result
    end
